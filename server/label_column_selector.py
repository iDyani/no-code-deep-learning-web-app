...
def select_label_column(original_data_folder, file_path, label_column):
    """
    ...
    try:
        ...
        # Optionally, you might want to save the entire dataset with the label column
        # marked or separated if that's required by your application logic
        ...
        with open(os.path.join(original_data_folder, 'column_data_types.json'), 'w') as json_file:
